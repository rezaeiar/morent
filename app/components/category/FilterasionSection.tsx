        ...
        <div>
            <div className="container px-4 mx-auto">
                <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-5 gap-5">
                    <div className="py-1 px-2.5 rounded-l-2xl bg-white border cursor-pointer border-e-0 border-secondary-100 absolute right-0 top-36 block lg:hidden" onClick={changeFilterDisplay}>
